...
const Slides: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
  return (
    <div className="outline-none border-none relative">
      <div
        className="absolute left-[30px] md:left-[250px] max-w-[250px]
      ...
      >
        ...
        <h3 className="text-[24px] text-gray-500">
          starting at <b className="text-[20px] md:text-[24px] lg:text-[30px] m-auto">{price}</b>
          .99
        </h3>
      ...
      <Image
        className="w-[75%] h-[200px] md:h-auto rounded-xl object-cover object-right md:object-left-bottom m-auto"
        src={img}
        alt="banner"
        width={2000}
        height={2000}
